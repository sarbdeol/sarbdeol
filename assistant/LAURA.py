...
ans=Text(top_frame,width=50,height=33,fg='black',bg='skyblue',yscrollcommand=scroll.set,wrap=WORD,)
    ...
    while True: 
            ...
            if 'hello' in query or 'hey' in query:
                ...
                if 'good' in query or 'fine' in query:
                    ...
                    speak('all is well, dont worry sir')
                    #break
            ...
            elif 'no thanks' in query or 'ok' in query:
            ...
            elif 'bye' in query or 'close' in query or 'exit' in query or 'stop' in query:
                speak('shutting down ')
                return exit(0) 
                ...
                elif 'music' in query or 'movie' in query:
            ...
            #============= wikipedia module ===========               
            elif 'search' in query or 'find'  in query or 'meaning' in query or 'what' in query:
                try:
...
if __name__=="__main__":
    ...
    speak('say wakeup or hello to continue \n')   
    while True:
        permission=takecommand().lower()
        
        if "up" in permission or  "hello" in permission:   
            wish()
